    ...
    public void opener(Player sender) {
        if (sender instanceof Player) {
            ...
            if (p.hasPermission("roleplay.rp")) {
                String configgetter = org.roguemc.roleplay.Roleplay.plugin.getConfig().getString("gui-name");
                Inventory inv = Bukkit.createInventory(p, 27, ChatColor.translateAlternateColorCodes('&', configgetter));
                String bookname = ChatColor.translateAlternateColorCodes('&', org.roguemc.roleplay.Roleplay.plugin.getConfig().getString("browse-name"));
                ItemStack browse = new ItemStack(Material.BOOK);
                ItemMeta meta = browse.getItemMeta();
                meta.setDisplayName(bookname);
                List<String> lore1 = new ArrayList<>();
                for (String all : org.roguemc.roleplay.Roleplay.plugin.getConfig().getStringList("browse-lore")) {
                ...
                String explainname = ChatColor.translateAlternateColorCodes('&', org.roguemc.roleplay.Roleplay.plugin.getConfig().getString("explanation-name"));
                ...
                for (String all : org.roguemc.roleplay.Roleplay.plugin.getConfig().getStringList("explanation-lore")) {
                ...
                String createrp = ChatColor.translateAlternateColorCodes('&', org.roguemc.roleplay.Roleplay.plugin.getConfig().getString("create-name"));
                ItemStack create = new ItemStack(Material.ITEM_FRAME);
                ItemMeta meta3 = create.getItemMeta();
                meta3.setDisplayName(createrp);
                List<String> lore3 = new ArrayList<>();
                for (String all : org.roguemc.roleplay.Roleplay.plugin.getConfig().getStringList("create-lore")) {
                ...
                String s = org.roguemc.roleplay.Roleplay.plugin.getConfig().getString("no-permission");
